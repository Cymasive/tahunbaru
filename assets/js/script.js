...
// Dirubah 
const pengirim = "Ga Tau, Org Benowo pokoknya";
const nomorWa = "6282245487574" // awalan nomor 0 harus di awalin 62
const textWa = "MASS CODING AN E SAMPEAN APIKK PUOLL SE, AKU TERHARU /Bercanda"
const pesan = `Selamat Tahun Baru Ya safina Natasya Ul Aulia, jujur gwej fans berat eloeh.. Tapi Bohong, Harapanku buat kamu selalu jadi safina yang baik like Bawang Merah, Eh Bawang Putih... Semoga Semua Cita2mu Di tahun 2024 bisa bener2 tercapai sekeluarga mu dikasih sehat, mau lebihh terbuka dan jujur se nde aku(AWM JAHAK SE, SUKA PHB), Jujur aku pengen selalu ada buat bocil kenjeran (km), HEH MINIM NGEKEI Pesan Balesan se wkwk`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Sikk Sikk, Ini Bener Safina ?',
    ...
    let txt = `Halo, Nama kamu ${result.value.login}, Owalaahhhh Hmmm Iki Pasti Siti, Tapi... Kokk Depa-nya ${namaAwal.toUpperCase()}, ${pesan}`;
